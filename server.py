...
def get_inventory_ordered():
    # Build list on-demand, but cache the JSON for a short time
    def build():
        orders = []
...
def get_inventory_ordered():
    ...
    # short TTL (e.g., 60s) keeps the UI snappy while staying fresh
    return send_cached_json("inventoryOrdered", build, ttl=60)
