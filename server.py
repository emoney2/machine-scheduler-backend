...
app = Flask(__name__)
CORS(app)  # allow * on all /api/*

# —————————————————————————————
# Configuration
# —————————————————————————————
# If you deploy someplace else you can override with the env var,
# otherwise it will load credentials.json in this folder.
...
def get_orders():
    try:
        ...
        # overlay any local persisted updates
